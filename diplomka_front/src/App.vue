<template>
    <nav class="py-10 px-8 border-b border-gray-200 bg-indigo-400">
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center justify-between">
                <div class="menu-left">
                    <a href="#" class="text-xl w-15 h-15 rounded-full"><img src="./assets/site_logo2.png" class="w-15 h-15 rounded-full"/></a>
                </div>
                ...
                <RouterLink to="/feed">
                    ...
                    <RouterLink to="/userchat" class="2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <FooterView v-if="isFooterVisible" />
    <Toast />
</template>
    ...
    export default {
        setup() {
            ...
            const route = useRoute()
             const isFooterVisible = !userStore.user.isAuthenticated && (route.name === 'login' || route.name === 'signup' )
            return {
                userStore,
               isFooterVisible
            }
