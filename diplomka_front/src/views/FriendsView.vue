    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
            ...
            >
                ...
                >
                    <img src="https://placebeard.it/250/250" class="mb-6 mx-auto rounded-full">
            ...
            >
                <div 
                    ...
                    v-bind:key="user.id"
                >
                    <img src="https://placebeard.it/250/250" class="mb-6 rounded-full">
        ...
        getFriends() {
            axios
                ...
                .then(response => {
                    ...
                    let r_data=response.data.message
                    if(r_data=='Friend request already sent'){
                        this.toastStore.showToast(5000, `${r_data}`, 'bg-red-300')
                    }else{
                        this.toastStore.showToast(5000, `${r_data}`, 'bg-emerald-300')
                    }
                })
                .catch(error => {
